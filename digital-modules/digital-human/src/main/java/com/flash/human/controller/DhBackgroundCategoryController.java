...
public class DhBackgroundCategoryController extends BaseController {
    ...
    public R<Void> changeStatus(@RequestBody DhBackgroundCategoryBo backgroundCategory) {
        return toAjax(dhBackgroundCategoryService.updateStatus(backgroundCategory.getId(), backgroundCategory.getStatus()));
    }
